...
class Path:
    ...
    def draw_path(self, win):
        ...
        # small pts
        path_pt_small = gr.Point(self.pos[0], self.pos[1])
        ...
        # medium pts
        path_pt_med = gr.Circle(gr.Point(self.pos[0], self.pos[1]), 1.3)
        ...
        # large pts
        path_pt_large = gr.Circle(gr.Point(self.pos[0], self.pos[1]), 2)
